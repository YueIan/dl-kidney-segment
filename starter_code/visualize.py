...
def visualize(cid, source, destination, hu_min=DEFAULT_HU_MIN, hu_max=DEFAULT_HU_MAX, 
    ...
    if plane == plane_opts[0]:
        ...
        for i in range(viz_ims0.shape[0]):
            ...
            scipy.misc.imsave(str(fpath), viz_ims0[i])
